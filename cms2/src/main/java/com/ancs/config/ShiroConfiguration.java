...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 --> 
     ...
     * @create  2016年1月14日
     */
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, SysUserRepository sysUserRepository){
        /////////////////////// 下面这些规则配置最好配置到配置文件中 ///////////////////////
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager,
       ...
       // shiroFilterFactoryBean.setSuccessUrl("/index");
        ...
        loadShiroFilterChain(shiroFilterFactoryBean, sysUserRepository);
